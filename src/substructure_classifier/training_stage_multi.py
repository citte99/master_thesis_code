...
class Stage:
    ...
    def __init__(self, classifier_instance, rank = None, gpu_id= None, config=None, stage_id=None, device='cuda'):
    ...
    def _load_dataloader(self, catalog_name, dataset_class_str, dataset_config=None, val=False):
        ...
        if val:
            return distributed_dataloader(dataset=dataset, batch_size=self.stage_properties.batch_size, shuffle=False)
        else:
            return distributed_dataloader(dataset=dataset, batch_size=self.stage_properties.batch_size)
